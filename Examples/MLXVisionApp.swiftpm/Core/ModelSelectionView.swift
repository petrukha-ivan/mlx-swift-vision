...
extension ModelSelection {
    static let presets: [ModelSelection] = [
        ...
        ModelSelection(id: "stevenbucaille/rf-detr-nano", revision: "main", type: .objectDetection),
        ModelSelection(id: "stevenbucaille/rf-detr-small", revision: "main", type: .objectDetection),
        ...
        ModelSelection(id: "stevenbucaille/rf-detr-seg-nano", revision: "main", type: .instanceSegmentation),
        ModelSelection(id: "stevenbucaille/rf-detr-seg-small", revision: "main", type: .instanceSegmentation),
