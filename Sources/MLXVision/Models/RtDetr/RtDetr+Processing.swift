...
final class RtDetrV2ForObjectDetectionProcessor: Processor {
    ...
    init(modelConfig: RtDetrV2ForObjectDetectionConfig, imagePreprocessor: ImagePreprocessor) {
    ...
    func postprocess(_ output: RtDetrV2ModelForObjectDetection.Output, _ request: ObjectDetectionRequest) throws -> [ObjectDetectionResult] {
