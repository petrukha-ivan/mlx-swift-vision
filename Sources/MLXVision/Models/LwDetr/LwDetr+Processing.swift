...
final class LwDetrForObjectDetectionProcessor: Processor {

    private let labels: [String]
    private let numQueries: Int
    private let imagePreprocessor: ImagePreprocessor

    init(modelConfig: LwDetrForObjectDetectionConfig, imagePreprocessor: ImagePreprocessor) {
    ...
    func postprocess(_ output: LwDetrModelForObjectDetection.Output, _ request: ObjectDetectionRequest) throws -> [ObjectDetectionResult] {
