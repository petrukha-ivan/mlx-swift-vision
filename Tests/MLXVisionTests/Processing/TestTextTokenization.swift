...
@Test func testTokenizationAlignedWithTransformers() async throws {
    ...
    let tokenizerURL = try await hubApi.snapshot(from: "openai/clip-vit-base-patch16", matching: ["vocab.json", "merges.txt"])
